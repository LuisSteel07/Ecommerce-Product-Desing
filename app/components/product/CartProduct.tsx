...
export default function CartProduct({product, count, setCount}: CartProductProps){
    return (
        <section className="flex flex-row gap-4 items-center text-black/60">
            <Image src={product.list_images[0]} alt="product image" className="w-16 rounded-md" />
            ...
            <Image src="/icon-delete.svg" alt="icon delete" className="w-4 h-4" onClick={() => setCount(0)} />
        </section>
    )
}